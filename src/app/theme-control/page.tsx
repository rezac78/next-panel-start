...
const Page = () => {
  return (
    <main className="container mx-auto w-full flex-1 space-y-6 py-9">
      <h1>Welcome to shadcn-crm-next</h1>
      <ThemeSwitch />
      <ThemeSelector />
      <ThemeControls />
      {/*<Hero/>*/}
      ...
      {/*<FAQ/>*/}
      {/*<CTA/>*/}
      <div className="bg-card mx-auto mt-8 flex h-64 w-64 items-center justify-center rounded-lg shadow">
        <p>Shadow Test Box</p>
      </div>
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            <div className="mx-auto max-w-2xl text-left lg:mx-0">
              ...
              <h1 className="from-foreground via-foreground/90 to-foreground/70 mb-6 bg-gradient-to-r bg-clip-text text-4xl font-bold tracking-tight text-transparent md:text-5xl lg:text-6xl">
                Design Your Perfect <span className="text-primary">shadcn/ui</span> Theme
              </h1>
